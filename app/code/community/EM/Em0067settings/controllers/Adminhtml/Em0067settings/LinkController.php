<?php
class EM_Em0067settings_Adminhtml_Em0067settings_LinkController extends Mage_Adminhtml_Controller_Action
{
	...
	public function userguideAction() {
		$this->getResponse()->setRedirect('http://www.emthemes.com/documentation/em0067-userguide/');
	}
