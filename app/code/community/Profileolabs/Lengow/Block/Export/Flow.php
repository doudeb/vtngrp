...
class Profileolabs_Lengow_Block_Export_Flow extends Mage_Core_Block_Template
{
    ...
    **/
    ...
    protected function _getPrices($product)
    {
        ...
        if($special_from_date != '' || $special_to_date != '')
        {
            ...
            elseif($special_from_date != '')
            {
                if($time < $this->mage2time($special_from_date))
                    $special_price = $price;
            }
            elseif($special_to_date != '')
            {
                if($time > $this->mage2time($special_to_date))
                    $special_price = $price;
            }
        }
    ...
    **/
    protected function _getStockSQL()
    {
    ...
    **/
    protected function _collection2Array($col, $field = 'entity_id')
    {
        $ar = array();
        foreach($col as $c)
        {
    ...
    **/
    ...
    protected function _formatData($str)
    {
