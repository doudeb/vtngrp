...
INSERT INTO {$installer->getTable('envoimoinscher/emc_services')} (id_es, code_es, emc_operators_code_eo, label_es, desc_es, desc_store_es, label_store_es, price_type_es, is_parcel_point_es, zones_es, family_es) VALUES
(1, 'RelaisColis', 'SOGP', 'Relais Colis®', 'Dépôt en Relais Colis - Livraison en Relais Colis en 3 à 5 jours, en France', 'Livraison en Relais Colis en 3 à 5 jours', 'Relais Colis®', 0, 1, 2, 1),
(2, 'Standard', 'UPSE', 'UPS Standard', 'Livraison à domicile en 24h à 72h (avant 19h), en France et dans les pays européens', 'Livraison à domicile en 24h à 72h (avant 19h)', 'UPS Standard', 0, 0, 3, 2),
(3, 'ExpressSaver', 'UPSE', 'UPS Express Saver', 'Livraison à domicile en 72h  (avant 19h), à l\'international  (hors délai de douanes)', 'Livraison à domicile en 72h (avant 19h, hors délai de douanes)', 'UPS Express Saver', 0, 0, 3, 2),
(4, 'InternationalEconomy', 'FEDX', 'FedEx International Economy', 'Livraison à domicile en 5 jours à l\'international (hors délai de douanes)', 'Livraison à domicile en 5 jours (hors délai de douanes)', 'FedEx International Economy', 0, 0, 1, 2),
(5, 'InternationalPriorityCC', 'FEDX', 'FedEx International Priority', 'Livraison express à domicile, en 24h à 48h (hors délai de douanes)', 'Livraison express à domicile en 24h à 48h (hors délai de douanes)', 'FedEx International Priority', 0, 0, 1, 2),
(6, 'ExpressNational', 'TNTE', '13:00 Express', 'Livraison express à domicile le lendemain (avant 13h), en France', 'Livraison express à domicile le lendemain (avant 13h)', '13:00 Express', 1, 0, 2, 2),
(7, 'Chrono13', 'CHRP', 'Chrono13', 'Dépôt en bureau de poste - Livraison express à domicile, le lendemain (avant 13h), en France. Dépôt en bureau de poste si la livraison rate.', 'Livraison express à domicile, le lendemain (avant 13h). Si la livraison rate, dépôt en bureau de poste', 'Chrono13 CC', 0, 0, 2, 2),
(8, 'ChronoInternationalClassic', 'CHRP', 'Chrono Classic', 'Dépôt en bureau de poste - Livraison à domicile en 2 à 4 jours, à l\'international (hors délai de douanes)', 'Livraison à domicile en 2 à 4 jours (hors délai de douanes)', 'Chrono Classic', 0, 0, 1, 2),
(9, 'NationalStandard', 'AGED', 'National Standard', 'Livraison à domicile en 21 jours, en France et en Europe de l\'ouest', 'Livraison à domicile en 21 jours', 'National Standard', 0, 0, 3, 2),
(10, 'ParcelExpress', 'ARAM', 'Parcel Express', 'Livraison express à domicile en 48h, en France', 'Livraison express à domicile en 48h', 'Parcel Express', 0, 0, 3, 2),
(11, 'TempoXpressFR', 'SERN', 'Tempo Xpress', 'Livraison à domicile en 2 à 3 jours, en France', 'Livraison à domicile en 2 à 3 jours', 'Tempo Xpress', 0, 0, 2, 2),
(12, 'ExpressStandard', 'SODX', 'Express Standard', 'Livraison à domicile en 2 à 3 jours, en France', 'Livraison à domicile en 2 à 3 jours', 'Express Standard', 0, 0, 2, 2),
(13, 'ExpressStandardInterColisMarch', 'SODX', 'Inter Express Standard', 'Livraison à domicile en 7 à 10 jours, à l\'international (hors délai de douanes)', 'Livraison à domicile en 7 à 10 jours (hors délai de douanes)', 'Inter Express Standard', 0, 0, 1, 2),
(14, 'ExpressStandardInterPlisDSVC', 'SODX', 'Inter Express Standard doc', 'Livraison à domicile en 7 à 10 jours, à l\'international (hors délai de douanes)', 'Livraison à domicile en 7 à 10 jours (hors délai de douanes)', 'Inter Express Standard doc', 0, 0, 1, 2),
(15, 'OffreDomestique', 'SLSP', 'PROMIUM LV2 REGULIER', 'Livraison de meubles/électroménager à domicile sur RDV, en 10 à 14 jours (date indicative), en France. Emballage par le transporteur', 'Livraison de meubles/électroménager à domicile sur RDV, en 2 semaines. Emballage par le transporteur', 'PROMIUM LV2 REGULIER', 0, 0, 2, 2),
(16, 'OffreFranceInf50kg', 'GUIN', 'Spécialiste transport de mobilier', 'Enlèvement sur RDV - Livraison de meubles à domicile sur RDV, en 7 à 14 jours (date indicative), en France principalement. Emballage par le transporteur', 'Livraison de meubles à domicile sur RDV, en 7 à 14 jours (date indicative). Emballage par le transporteur', 'Spécialiste transport de mobilier', 0, 0, 2, 2),
(17, 'OffreFranceInf80cc', 'DTBK', 'Cylindrée jusquà 50 cm3', 'Enlèvement sur RDV - Livraison de deux-roues à domicile sur RDV, en 7 à 14 jours (date indicative), en France', 'Livraison de deux-roues à domicile sur RDV, en 7 à 14 jours (date indicative)', 'Cylindrée jusquà 50 cm3', 0, 0, 2, 2),
(18, 'CpourToi', 'MONR', 'C.pourToi®', 'Dépôt en point relais - Livraison en point relais en 3 à 5 jours, en France', 'Livraison en point relais en 3 à 5 jours', 'C.pourToi®', 0, 1, 2, 1),
(19, 'CpourToiEurope', 'MONR', 'C.pourToi® - Europe', 'Dépôt en point relais - Livraison en point relais en 4 à 6 jours, dans certains pays d\'Europe', 'Livraison en point relais en 4 à 6 jours', 'C.pourToi® - Europe', 0, 1, 1, 1),
(20, 'EconomyExpressInternational', 'TNTE', 'Economy Express', 'Livraison à domicile en 2 à 5 jours, à l\'international (hors délai de douanes)', 'Livraison à domicile en 2 à 5 jours (hors délai de douanes)', 'Economy Express', 0, 0, 1, 2),
(21, 'ExpressWorldwide', 'DHLE', 'DHL Express Worldwide', 'Livraison express à domicile en 24h à 72h, à l\'international (hors délai de douanes)', 'Livraison express à domicile en 24h à 72h (hors délai de douanes)', 'DHL Express Worldwide', 0, 0, 1, 2),
(22, 'DepotexpressEurope', 'LOCO', 'Dépôt Express Europe', 'Dépôt en bureau de poste - Livraison à domicile en 2 à 4 jours, en Europe (hors délai de douanes)', 'Livraison à domicile en 2 à 4 jours (hors délai de douanes)', 'Dépôt Express Europe', 0, 0, 1, 2),
(23, 'Depotexpress', 'LOCO', 'Dépôt Express', 'Dépôt en bureau de poste - Livraison express à domicile, le lendemain (avant 13h), en France. Dépôt en bureau de poste si la livraison rate.', 'Livraison express à domicile, le lendemain (avant 13h). Si la livraison rate, dépôt en bureau de poste', 'Dépôt Express', 0, 0, 2, 2);
...
CREATE TABLE {$installer->getTable('envoimoinscher/emc_points_tmp')} (
...
{
  $query = $query."  INSERT INTO {$installer->getTable('sales/order_status')} (status, label) 
