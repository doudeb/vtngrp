...
{ 
  ...
  public function listOperators() 
  {
    ...
    foreach($collection->getData() as $o => $operator) 
    {
      $arr[$operator['code_eo']] = array('id' => $operator['id_eo'], 'value' => $operator['code_eo'], 'label' => $operator['name_eo'],
      'desc' => $operator['desc_eo'], 'pricing' => $operator['price_type_eo'],
      'store_title' => $operator['name_store_eo'], 'store_desc' => $operator['desc_store_eo']
      );
    }
    return $arr;
  }
